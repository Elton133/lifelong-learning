...
INSERT INTO learning_content (id, title, description, content_type, difficulty, estimated_duration, skill_ids, category, content_data, xp_reward) VALUES
  ...
  -- Additional content for various categories
  (
    '11111111-aaaa-aaaa-aaaa-111111111111',
    'Introduction to Photography',
    'Learn the basics of composition, lighting, and camera settings',
    'video',
    'beginner',
    8,
    ARRAY['11111111-1111-1111-1111-111111111111'::uuid],
    'photography',
    '{"video_url": "https://example.com/photography-basics"}',
    30
  ),
  (
    ...
    ARRAY['22222222-2222-2222-2222-222222222222'::uuid],
    'fashion',
    '{"interactive_elements": [{"type": "quiz", "data": {}}]}',
    15
  ),
  (
    '33333333-cccc-cccc-cccc-333333333333',
    'Music Theory Fundamentals',
    'Understand scales, chords, and harmony basics',
    'video',
    'intermediate',
    10,
    ARRAY['33333333-3333-3333-3333-333333333333'::uuid],
    'music',
    '{"video_url": "https://example.com/music-theory"}',
    35
  ),
  (
    '44444444-dddd-dddd-dddd-444444444444',
    'Personal Finance Management',
    'Master budgeting, saving, and investment strategies',
    'interactive',
    'beginner',
    12,
    ARRAY['44444444-4444-4444-4444-444444444444'::uuid],
    'finance',
    '{"interactive_elements": [{"type": "calculator", "data": {}}]}',
    40
  ),
  (
    '55555555-eeee-eeee-eeee-555555555555',
    'Cooking Basics: Essential Techniques',
    'Learn knife skills, cooking methods, and recipe fundamentals',
    'video',
    'beginner',
    15,
    ARRAY['55555555-5555-5555-5555-555555555555'::uuid],
    'cooking',
    '{"video_url": "https://example.com/cooking-basics"}',
    45
  ),
  (
    '66666666-ffff-ffff-ffff-666666666666',
    'Fitness: Full Body Workout',
    'A comprehensive workout routine for all fitness levels',
    'video',
    'beginner',
    20,
    ARRAY['66666666-6666-6666-6666-666666666666'::uuid],
    'fitness',
    '{"video_url": "https://example.com/full-body-workout"}',
    50
  ),
  (
    '77777777-gggg-gggg-gggg-777777777777',
    'Travel Planning Essentials',
    'Learn how to plan, budget, and make the most of your trips',
    'interactive',
    'beginner',
    7,
    ARRAY['77777777-7777-7777-7777-777777777777'::uuid],
    'travel',
    '{"interactive_elements": [{"type": "checklist", "data": {}}]}',
    25
  ),
  (
    '88888888-hhhh-hhhh-hhhh-888888888888',
    'Business Strategy Fundamentals',
    'Introduction to strategic planning and business analysis',
    'video',
    'intermediate',
    15,
    ARRAY['88888888-8888-8888-8888-888888888888'::uuid],
    'business',
    '{"video_url": "https://example.com/business-strategy"}',
    45
  ),
  (
    '99999999-iiii-iiii-iiii-999999999999',
    ...
    ARRAY['11111111-1111-1111-1111-111111111111'::uuid],
    'reading',
    '{"interactive_elements": [{"type": "exercise", "data": {}}]}',
    20
  ),
  (
    'aaaaaaaa-jjjj-jjjj-jjjj-aaaaaaaaaaaa',
    'Web Design Principles',
    'Learn the fundamentals of modern web design',
    'video',
    'intermediate',
    12,
    ARRAY['22222222-2222-2222-2222-222222222222'::uuid],
  ...
  (
    'bbbbbbbb-kkkk-kkkk-kkkk-bbbbbbbbbbbb',
    'Leadership Communication Skills',
    'Develop effective communication as a leader',
    'scenario',
    'intermediate',
    10,
    ARRAY['66666666-6666-6666-6666-666666666666'::uuid],
    'leadership',
    '{"scenario_steps": [{"id": "s1", "description": "Practice difficult conversations", "choices": []}]}',
    35
  ),
  (
    'cccccccc-llll-llll-llll-cccccccccccc',
    'Creative Problem Solving',
    'Learn techniques to approach problems creatively',
    'interactive',
    'beginner',
    8,
    ARRAY['77777777-7777-7777-7777-777777777777'::uuid],
    'creativity',
    '{"interactive_elements": [{"type": "brainstorm", "data": {}}]}',
    30
  ),
  (
    'dddddddd-mmmm-mmmm-mmmm-dddddddddddd',
    'Innovation in Tech',
    'Explore emerging technologies and innovation trends',
    'video',
    'advanced',
    18,
    ARRAY['11111111-1111-1111-1111-111111111111'::uuid],
    'innovation',
    '{"video_url": "https://example.com/tech-innovation"}',
    55
  ),
  (
    'eeeeeeee-nnnn-nnnn-nnnn-eeeeeeeeeeee',
    ...
    ARRAY['66666666-6666-6666-6666-666666666666'::uuid],
    'health',
    '{"video_url": "https://example.com/health-wellness"}',
    35
  );
