    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="p-4 border-t border-border">
          ...
          {/* Sign out button */}
          <button className="flex items-center gap-3 w-full px-3 py-2.5 text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted rounded-xl transition-all duration-200">
